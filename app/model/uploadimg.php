...
/**
 * Uploadimg 封装来自 upload_img 数据表的记录及领域逻辑
 */
class Uploadimg extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'path' => array
                (
                    array('not_empty', 'path不能为空'),
                    array('max_length', 255, 'path不能超过 255 个字符'),

                ),

                'user_id' => array
                (
                    array('is_int', 'user_id必须是一个整数'),

                ),

                'username' => array
                (
                    array('max_length', 255, 'username不能超过 255 个字符'),
