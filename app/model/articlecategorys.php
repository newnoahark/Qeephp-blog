...
/**
 * Articlecategorys 封装来自 article_category 数据表的记录及领域逻辑
 */
class Articlecategorys extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'name' => array
                (
                    array('not_empty', '文章类别不能为空'),
                    array('max_length', 50, '文章类别不能超过 50 个字符'),

                ),

                'date' => array
                (
                    array('max_length', 255, 'date不能超过 255 个字符'),
