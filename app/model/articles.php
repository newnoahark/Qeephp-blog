...
/**
 * Articles 封装来自 article 数据表的记录及领域逻辑
 * 文章模型
 */
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'title' => array
                (
                    array('not_empty', '文章标题不能为空'),
                    array('max_length', 100, '文章标题不能超过 100 个字符'),

                ),

                'author' => array
                (
                    array('not_empty', '文章作者不能为空'),
                    array('max_length', 40, '文章作者不能超过 40 个字符'),

                ),

                'form' => array
                (
                    array('not_empty', '文章来源不能为空'),
                    array('max_length', 40, '文章来源不能超过 40 个字符'),

                ),

                'desc' => array
                (
                    array('not_empty', '文章描述不能为空'),
                    array('max_length', 100, '文章描述不能超过 100 个字符'),

                ),

                'category_id' => array
                (
                    array('is_int', '分类id必须是一个整数'),
                ...
                'thumb' => array
                (
                    array('not_empty', '文章封面不能为空'),
                    array('max_length', 100, '文章封面不能超过 100 个字符'),

                ),

                'status' => array
                (
                    array('is_int', '文章状态必须是一个整数'),

                ),

                'view_count' => array
                (
                    array('is_int', '浏览数必须是一个整数'),
