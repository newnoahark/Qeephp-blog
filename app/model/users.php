        ...
        (
            ...
            (
                ...
                'acluser'=>array(
                    ...
                    'acl_data_props' => 'id,name,email,password,status,confirm_email',
                    'roles_enabled' => true,
                    'roles_prop' => 'roles',
            ...
            (
                ...
                'roles' => array(
                    ...
                    'mid_table_name' => 'user_roles',
                    'mid_source_key' => 'user_id',
                    'mid_target_key' => 'roles_id',
                    'source_key'     => 'id',
                    'target_key'     => 'id',
                )
            ),
            ...
            (
                ...
                (
                    ...
                    array('max_length', 100, '姓名不能超过 100 个字符'),
                ...
                (
                    ...
                    array('max_length', 100, '邮箱不能超过 100 个字符'),
                ...
                (
                    ...
                    array('max_length', 60, '密码不能超过 60 个字符'),
