...
<title><?php $this->_block('titles')?>创建文章<?php $this->_endblock()?></title>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel">
                ...
                <form action="<?php echo url('default/createposts');?>" class="form-horizontal" method="post" id="create_article">
                    <div class="panel-body">
                        <fieldset class="form-group">
                            <label for="demo-title" class="col-sm-3 control-label">标题</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" placeholder="标题" name="posts-title">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            <label for="demo-author" class="col-sm-3 control-label">作者</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" placeholder="作者" name="posts-author">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            <label for="demo-from" class="col-sm-3 control-label">来源</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" placeholder="来源" name="posts-from">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            <label for="demo-desc" class="col-sm-3 control-label">描述</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" placeholder="描述" name="posts-desc">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            ...
                            <div class="col-sm-5 thumb-image">
                                <a href="javascript:void(0);"  class="thumbnail" >
                                    <img src=""  alt="选择封面图像" class="img-responsive" title="文章封面" />
                                    <input type="hidden" name="posts-img">
                                </a>
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                        ...
                        <fieldset class="from-group">
                            ...
                            <div id="test-editormd">
                                <textarea style="display:none;" name="post-content" id="content"></textarea>
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
